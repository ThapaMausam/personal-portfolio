...
const AboutMe = () => {
  return (
    <section className="py-20 px-6 font-sans relative bg-slate-900">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-between gap-6 text-sm md:text-base">
            <div className="flex items-center gap-3">
              ...
              <span className="text-slate-500 font-medium uppercase tracking-wider text-xs">Location</span>
              <span className="text-slate-200 font-semibold">India</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-purple-500"></span>
              <span className="text-slate-500 font-medium uppercase tracking-wider text-xs">Experience</span>
              <span className="text-slate-200 font-semibold">Student</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
              <span className="text-slate-500 font-medium uppercase tracking-wider text-xs">Focus</span>
              <span className="text-slate-200 font-semibold">Full-Stack Web Development</span>
            </div>
          </div>
        </motion.div>
      </div>
